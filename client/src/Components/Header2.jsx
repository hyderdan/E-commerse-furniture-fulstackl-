    ...
    return (
        <div>
            ...
            <nav className={`nav ${opennav ? 'openNav' : ''}`}>
                ...
                <a href="#" className="logo">DEFINED DESIGN</a>
                ...
                <i className={`uil ${opensearch ? 'uil-times' : 'uil-search'} search-icon`} id="searchIcon" onClick={()=>togglesearch()}><FaSearch /></i>
                {opensearch && (
                    <div className="search-box">
                        <i className="uil uil-search search-icon"><IoClose /></i>
